...
echo "Channel name:`date -u`\nURL1:http//www.A `git rev-list --all --count origin/main`" >> "WebTV List.txt"
echo "Channel name:`git rev-list --count --since=yesterday --before=today main`" >> "WebTV List.txt"
